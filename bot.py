...
# বটের কমান্ড মেনু (Slash Menu) অটো সেট করার ফাংশন
...
def get_player_data(uid):
    ...
    try:
        ...
        if not response.ok or 'error' in data:
            return None, data.get('error', "Connection failed. Invalid UID or API limit exceeded.")
        return data, None
    except Exception as e:
        return None, str(e)
...
def main():
    set_bot_commands()
    print("🤖 TYNEX INFO CHECKER Bot is running with Vertical Stack Buttons & Corrected Spelling...")
    offset = None
            ...
            if "message" in update and "text" in update["message"]:
                ...
                if command == "/info":
                    if len(parts) > 1 and parts[1].isdigit():
                        ...
                        send_message(chat_id, "❌ *Please provide a valid UID after command!*\nExample: `/info 2287422745`", parse_mode="Markdown", reply_to_message_id=message_id)
                        continue
                ...
                if uid:
                    ...
                    if err:
                        send_message(chat_id, f"❌ *Error:* {err}", parse_mode="Markdown", reply_to_message_id=message_id)
                        continue
                    ...
                    # দুটি বাটন এখন উপরে-নিচে (Vertical) সুন্দর বড় বড় ও সমান আকারে থাকবে
                    reply_markup = {
                        "inline_keyboard": [
